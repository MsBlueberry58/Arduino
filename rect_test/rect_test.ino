...
void setup() {
  ...
  //tft.drawRect(x_logo, y_logo, w_logo, h_logo, color_logo);
  drawBitmap(8, 36, kyogre, 96, 96, WHITE);
  //tft.drawCircle(8+(96/2), 36+96+18+36, 36, WHITE);
  //tft.fillCircle(8+(96/2), 36+96+36+18, 36, WHITE);
}

void loop() {
  drawPkm(pkcut);
  delay(1000);
  drawPkm("4/Charmander/Fire");
  delay(1000);
  drawPkm("7/Squirtle/Water");
  delay(1000);
